...
parser.add_argument('--follow_distance', type=float, default=0.95, help='65 cm (Distance between the GPS and the rear of the F1sixth.) + Distance between the vehicles')
