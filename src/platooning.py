...
parser.add_argument('--wheelbase', type=float, default=0.48, help='distance between the front and rear axles')
parser.add_argument('--follow_distance', type=float, default=1.0, help='65 cm (Distance between the GPS and the rear of the F1sixth.) + Distance between the vehicles + 15 cm (Distance between the front of the F1sixth and the GPS.)')
parser.add_argument('--speed_max', type=float, default=4.0)
parser.add_argument('--speed_min', type=float, default=0.0)
parser.add_argument('--accel_max', type=float, default=4.0)
parser.add_argument('--accel_min', type=float, default=-4.0)
parser.add_argument('--steer_max', type=float, default=45.0)
parser.add_argument('--steer_min', type=float, default=-45.0)
...
parser.add_argument('--I_max', type=float, default=10)
...
parser.add_argument('--PD_Kd', type=float, default=0.01)
...
if __name__ == '__main__':
    ...
    if args.ros_version == 'ros1':
        ...
        from control_ros2 import ROS2Control
        import rclpy
