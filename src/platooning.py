...
parser.add_argument('--follow_distance', type=float, default=0.2)
parser.add_argument('--speed_max', type=float, default=4.0)
parser.add_argument('--speed_min', type=float, default=0.0)
parser.add_argument('--accel_max', type=float, default=6.0)
parser.add_argument('--accel_min', type=float, default=-6.0)
